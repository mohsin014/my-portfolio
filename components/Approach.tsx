    ...
    <section className="w-full my-20">
      ...
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center gap-4">
       <Card 
            ...
            description= "We will collaborate to map out your website goals, target audience, and key funcionalities. We will discuss things like site structure, navigation and content requirements"
            >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            ...
            description= "Once we all agree on the plan i dive into coding. From Initial Sketches to Polished code, I keep you updated at every step of the way"
            >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            ...
            description = "This is where the magic happens. Based on the approved design, I'will translate everything into funcional code, building your website from the ground up"
            >
          <CanvasRevealEffect
            animationSpeed={3}
